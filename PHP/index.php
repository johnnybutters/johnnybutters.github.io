...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Home Library</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#InStock">In Stock</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-default page-scroll" href="#Users">Click Me to Scroll Down!</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- In Stock Section -->
    <section id="In Stock" class="InStock-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>In Stock</h1>
    ...
    <!-- Add Book Section -->
    <section id="Add Book" class="AddBook-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Add Book</h1>
